...
config = {
    ...
    "CALC_STATS_INTERVAL_HOURS": 0.05, # 3 minutes
    "CLEANUP_INTERVAL_HOURS": 0.005, # 20 sec
    "RUN_AGE_THRESHOLD_DAYS": 0.0001, # 0,15 min = 10 sec
    "REACTIVATION_PERIOD_DAYS": 0.0001
}
